...
export default {
    ...
    agent: {
        cloud: { loadFailed: "加载云 Agent 失败", session: "选择会话", newSession: "新会话名称", create: "创建", prompt: "描述需要 Agent 完成的创作任务", run: "开始任务", detail: "任务详情", model: "逻辑模型", skills: "允许的 Skills", applyCanvas: "应用到当前 Canvas", decline: "拒绝", approve: "批准" },

...
export default {
    ...
    agent: {
        cloud: { loadFailed: "Failed to load cloud Agent", session: "Select session", newSession: "New session name", create: "Create", prompt: "Describe the creative task for the Agent", run: "Start run", detail: "Run details", model: "Logical model", skills: "Allowed Skills", applyCanvas: "Apply to current Canvas", decline: "Decline", approve: "Approve" },

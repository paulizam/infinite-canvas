export default {
    ...
    agent: {
        cloud: { loadFailed: "Failed to load cloud Agent", session: "Select session", newSession: "New session name", create: "Create", prompt: "Describe the creative task for the Agent", run: "Start run", detail: "Run details", decline: "Decline", approve: "Approve" },

...
export default {
    ...
    canvas: {
        ...
        workflow: { button: "Workflow", title: "Publish and run Workflow", unpublished: "Not published", canvasRevision: "Current Canvas revision: {{revision}}", refresh: "Refresh", publish: "Publish version", diagnostics: "Compile diagnostics", locate: "Locate node", history: "Version history", noVersions: "No published versions", loadFailed: "Failed to load workflow", publishFailed: "Failed to publish workflow", execution: { title: "Execution center", selectNodes: "Select start nodes", runAll: "Run all", runSelected: "Run selected", cancel: "Cancel", empty: "No executions yet", timeline: "Execution timeline", snapshots: "Input/output snapshots", loadFailed: "Failed to load executions", runFailed: "Failed to create execution", cancelFailed: "Failed to cancel execution", retryFailed: "Failed to retry node" }, api: { title: "Public Workflow API", loadFailed: "Failed to load API tokens", createFailed: "Failed to create API token", rotateFailed: "Failed to rotate API token", revokeFailed: "Failed to revoke API token", name: "Token name", create: "Create token", rotate: "Rotate token", revoke: "Revoke token", secretTitle: "Save API secret", secretOnce: "This secret is shown only once. Save it securely now.", copySnippet: "Copy API snippet" }, library: { title: "Workflow library", loadFailed: "Failed to load the library", folderFailed: "Folder operation failed", updateFailed: "Failed to update workflow", exportFailed: "Failed to export workflow", importFailed: "Failed to import workflow", tooLarge: "Import file cannot exceed 2 MiB", folderName: "New folder", import: "Import", noDescription: "No description", folder: "Folder", edit: "Edit workflow details", description: "Description", tags: "Tags", coverAsset: "Cover Asset ID" } },
        ...
        configNode: { title: "Generation config", image: "Image", text: "Text", video: "Video", audio: "Audio", prompt: "Prompt", references: "Reference images", videoReferences: "Reference videos", audioReferences: "Reference audio", items: "{{count}} items", images: "{{count}} images", compose: "Compose prompt", stop: "Stop", generate: "Generate", billingLoading: "Estimating points…", billingUnavailable: "Points estimate unavailable", billingEstimate: "Estimated {{points}} points", billingBalance: "Balance {{points}}", insufficientPoints: "Insufficient points" },
        projectPage: {
            stopTitle: "Stop generation?", stopDescription: "The current request will be interrupted. Completed results will be kept.", stop: "Stop", continue: "Continue generating", configConnection: "Configuration nodes cannot be connected to each other", notFound: "Current canvas not found", exporting: "Exporting current canvas…", exported: "Current canvas exported", clipboardText: "Clipboard text", clipboardImageAdded: "Added image from clipboard", clipboardTextAdded: "Added text from clipboard", noTextToSave: "No text to save", canvasText: "Canvas text", noVideoToSave: "No video to save", canvasVideo: "Canvas video", noImageToSave: "No image to save", canvasImage: "Canvas image", emptyReverse: "The image node is empty, so its prompt cannot be inferred", reverseTitle: "Reverse prompt", reverseConfigTitle: "Reverse prompt configuration", splitTitle: "{{name}} {{row}}-{{column}}", splitSuccess: "Split into {{count}} child nodes", maskResult: "Local edit result", maskFailed: "Local edit failed", generationFailed: "Generation failed", partialFailed: "Some images failed to generate", partialTextFailed: "Some text alternatives failed to generate", allFailed: "All images failed to generate", retryPromptMissing: "No prompt found for retry", referenceMissing: "The reference image is missing, so retry cannot continue", emptyTextImage: "The text node is empty, so an image cannot be generated", untitledCanvas: "Untitled canvas", imageDetails: "Image details", clearTitle: "Clear canvas?", clear: "Clear", clearDescription: "This will delete every node and connection on the current canvas.", reversePreset: "Infer a prompt suitable for AI image generation from the reference image.\n\nRequirements:\n1. Output only the prompt, with no explanation.\n2. Cover the subject, composition, style, lighting, color, materials, lens, and atmosphere.\n3. Write a complete prompt that can be used directly with an image model.", maskPrompt: "Only modify the transparent masked area and keep everything else unchanged. {{prompt}}", editTextPrompt: "Revise the text according to the instructions.\n\nOriginal:\n{{source}}\n\nInstructions:\n{{prompt}}"
        },
        reverseComposer: "Reference image: @[node:{{imageId}}]\nTask: @[node:{{textId}}]",
        superResolution: { title: "AI super resolution", description: "Reconstruct high-resolution detail with the current image model and create a connected result node.", model: "Generation model", defaultModel: "Default image model", detail: "Detail strategy", faithful: "Faithful", enhanced: "Enhanced detail", submit: "Start AI super resolution", resultTitle: "AI super-resolution result", faithfulPrompt: "Apply AI super-resolution reconstruction to the reference image with a target long edge of {{target}} pixels. Strictly preserve the original subject, composition, aspect ratio, colors, text, and style. Add or remove nothing; only remove compression artifacts, aliasing, and noise while restoring natural, crisp texture. Return only the processed image.", enhancedPrompt: "Apply AI super-resolution reconstruction to the reference image with a target long edge of {{target}} pixels. Preserve the original subject, composition, aspect ratio, colors, text, and style while enhancing credible edges, materials, and fine texture without changing meaning. Do not add objects. Return only the processed image." },
        editors: {
    ...
    agent: {
        cloud: { loadFailed: "Failed to load cloud Agent", session: "Select session", newSession: "New session name", create: "Create", prompt: "Describe the creative task for the Agent", run: "Start run", detail: "Run details", model: "Logical model", skills: "Allowed Skills", applyCanvas: "Apply to current Canvas", canvasApplied: "Applied to Canvas", openAssets: "Open in Assets", sendDrama: "Send to Drama", sentDrama: "Sent to Drama", dramaId: "Drama project ID", dramaRevision: "Current Drama revision", dramaEntityKind: "Entity kind", dramaEntityName: "Entity name", character: "Character", scene: "Scene", prop: "Prop", description: "Description", entityPrompt: "Entity prompt", sortOrder: "Sort order", decline: "Decline", approve: "Approve" },
        ...
        skillManager: {
            codexBusy: "Codex is running. Finish the current task before extracting a Skill.", noConversation: "This conversation has no completed content to extract", noCanvas: "There is no canvas on this page to extract", connecting: "This page is still connecting to the Agent. Try again shortly.", syncFailed: "Failed to sync the current canvas. Check the Agent connection and try again.", noDraft: "No Skill draft was generated", draftCreated: "Draft generated. Review it on the Skills tab before creating it.", draftFailed: "Failed to generate Skill draft", contentMissing: "Skill content was not returned", readFailed: "Failed to read Skill", defaultPromptMention: "The default prompt must include ${{name}}", created: "Skill created", updated: "Skill updated", saveFailed: "Failed to save Skill", deleteTitle: "Delete {{name}}", deleteDescription: "The local files cannot be recovered after deletion. Continue?", delete: "Delete", deleted: "Skill deleted", deleteFailed: "Failed to delete Skill", statusFailed: "Failed to update Skill status", installGithub: "Install from GitHub", installGithubDescription: "Review source, files, and permissions before writing locally", searchGithub: "Search GitHub Skills", searchPlaceholder: "Enter a use case or keyword", searchAction: "Search", searchRequired: "Enter at least 2 characters", searchFailed: "GitHub Skill search failed", installSource: "GitHub Skill URL", installSourceRequired: "Enter a GitHub Skill URL", previewInstall: "Security preview", installPreviewMissing: "The install preview was not returned", installPreviewFailed: "Failed to create the install preview", installNow: "Confirm and install", installFiles: "Source files ({{count}})", installPermissions: "Confirm install permissions", installNoPermissions: "No additional permissions were declared or inferred", installSafetyNote: "Content is pinned to a commit SHA; the installer never executes remote scripts.", installed: "{{name}} installed", installFailed: "Failed to install the Skill",
        ...
        panel: { connectionSettings: "Connection settings · {{status}}", connectionSettingsLabel: "Connection settings. Current status: {{status}}", chat: "Chat", history: "History", skills: "Skills", runs: "Cloud runs", logs: "Logs", collapse: "Collapse chat", collapseLabel: "Collapse Agent panel", resize: "Resize right panel", content: "Agent content", mcpInitializing: "MCP is initializing. You can send messages when it is ready.", initFailed: "Codex conversation initialization failed. Start or resume a conversation.", placeholder: "Ask Codex, type / for Skills, or @ to reference canvas assets" },
    ...
    studio: {
        studioView: "Creative Studio", canvasView: "Canvas view", projects: "Back to projects", revision: "Project revision r{{revision}}", refresh: "Refresh cloud results", search: "Search nodes, prompts, or content", allNodes: "All nodes", resultCount: "{{count}} results", sameProjectHint: "Both views share the same project data", empty: "No results match these filters", projectMissing: "Project is missing or has not synced", loadFailed: "Could not load cloud results", downloadFailed: "Download failed", download: "Download result", focusNode: "Focus node on canvas",
        kind: { all: "All media", text: "Text", image: "Images", video: "Videos", audio: "Audio" },
    ...
    checkpoint: { history: "Versions", title: "Project checkpoints", create: "Save current version", namePlaceholder: "Checkpoint name", descriptionPlaceholder: "Description (optional)", empty: "No checkpoints", noDescription: "No description", preview: "{{title}} · {{nodes}} nodes · {{connections}} connections", restore: "Restore", restoreConfirm: "Restore this checkpoint as a new project revision?", deleteConfirm: "Permanently delete this checkpoint?", created: "Checkpoint saved", restored: "Restored as a new revision", deleted: "Checkpoint deleted", loadFailed: "Could not load checkpoints", createFailed: "Could not create checkpoint", restoreFailed: "Could not restore checkpoint", deleteFailed: "Could not delete checkpoint" },
    locale: {
        zhCN: "简体中文",
        enUS: "English",
    },
